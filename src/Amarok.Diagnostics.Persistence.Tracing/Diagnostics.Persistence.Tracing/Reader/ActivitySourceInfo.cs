...
/// 
/// <remarks>
///     Every activity is associated with a single activity source, which is used primarily for categorizing all the
///     activities of an instrumented application based on their origin.
/// </remarks>
/// 
/// <param name="Name">
