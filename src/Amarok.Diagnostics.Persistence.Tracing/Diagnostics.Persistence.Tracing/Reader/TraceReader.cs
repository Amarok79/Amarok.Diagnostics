...
public static class TraceReader
{
    ...
    /// 
    /// <returns>
    ///     An object capable of reading a stream of activities. Don't forget to dispose the returned reader instance;
    ///     otherwise the supplied stream will stay open.
    /// </returns>
    ...
    /// <returns>
    ///     An object capable of reading a stream of activities. Don't forget to dispose the returned reader instance;
    ///     otherwise the trace log file will stay open.
    /// </returns>
    ...
    /// 
    /// <returns>
    ///     An object capable of reading a stream of activities from the trace log files located in the specified source
    ///     folder. Don't forget to dispose the returned reader instance; otherwise some trace log files will stay open.
    /// </returns>
    ...
    /// 
    /// <returns>
    ///     An object capable of reading a stream of activities from the Zip archive. Don't forget to dispose the returned
    ///     reader instance; otherwise the Zip archive will stay open.
    /// </returns>
